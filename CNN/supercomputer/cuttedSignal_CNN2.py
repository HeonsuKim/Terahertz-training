...
#plt.plot(signal_sur[0+55+30:100+55-10,29999])
#plt.plot(signal_del[0+55+30:100+55-10,25650-243+102])
...
a2=io.loadmat('D:\\Dropbox\\THz\\data\\year2020\\201104\\data13.mat')
#a.keys()
...
for i in range(int(signal_sur.shape[1])):       #dat.shape[1]-1
...
#for i in range(int(signal_bot.shape[1])):       #dat.shape[1]-1
#
...
a2=io.loadmat('D:\\Dropbox\\THz\\data\\year2020\\201104\\data14.mat')
#a.keys()
...
model.fit(spectrogram_np, label_np, epochs=30, validation_data=(spectrogram_np[0:925200][:][:][:], label_np[0:925200][:][:][:]))
...
#np.save('D:\\Dropbox\\THz\\data\\year2020\\201104\\spectrogram_np2_sizeup_other',spectrogram_np)
#np.save('D:\\Dropbox\\THz\\data\\year2020\\201104\\label_np2_sizeup_other',label_np)
...
#model.save_weights('C:\\Users\\user03\\PycharmProjects\\heonsu\\CNN\\saved_model2\\my_model1')
model.load_weights('C:\\Users\\user03\\PycharmProjects\\heonsu\\CNN\\saved_model2\\my_model2')

spectrogram_np=np.load('D:\\Dropbox\\THz\\data\\year2020\\201104\\spectrogram_np2_sizeup_other.npy')
label_np=np.load('D:\\Dropbox\\THz\\data\\year2020\\201104\\label_np2_sizeup_other.npy')
